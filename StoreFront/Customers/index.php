...
<body>
    ...
    <h1><center>StoreFront<center></h1>
        ...
        <h2>Choose your Option</h2>
      	...
      	<div class="w3-container">
		<center><a href="register.php"><input type="submit" value="Register as Customers"></a></center>
		<center><a href="register.php"><input type="submit" value="Register as Retailers"></a></center>
      	</div>
        ...
        <h2>Choose your Option</h2>
      	...
      	<div class="w3-container">
		<center><a href="login.php"><input type="submit" value="Login as Customers"></a></center>
		<center><a href="login.php"><input type="submit" value="Login as Retailers"></a></center>
      	</div>
      		<footer class="w3-container w3-teal">
        	<p>Thank You!</p>
      	</footer>
