...
$Name_Err = $gender_Err = $age_Err = $address_Err = $contact_Err = $email_Err = $password_Err = $verify_Password_Err = '';
...
<label>Name: </label>
<input type="text" required name="name" placeholder="Name" autocomplete="off" value="<?php echo isset($_POST["name"]) ? $_POST["name"] : '';?>">
...
<label>Age: </label>
<input type="number" required name="age" min="1" max="120" autocomplete="off">
...
<?php
echo '<input type="submit" name="register" onclick="alert(\'Account Created Successfully!\')" value="Register as Customers">';
?>
</form>
